"""
RQ4: Evaluate DM-SUDS on imagenet with ddh
"""
...
def get_args():
    ...
    parser.add_argument("--save_dir", type=str, default="results/rq4_ddh")
...
def main():
    ...
    with open(os.path.join(args.save_dir, 'imagenet_ddh_table.txt'), 'w') as file:
        file.write(table)
