"""
Create a diagram for evaluating the effect of not using noise in the diffusion process.
...
if __name__ == "__main__":
    ...
    for steg in ["lsb", "ddh", "udh"]:
        input_path = f"../results/rq3/{steg}"
        output_path = f"../results/rq3_no_added_noise_{steg}.pdf"
        ref_path = "../results/rq3"
