"""
Make plots for RQ3: effect of no added noise
...
# File paths
#
file_ddh = '../results/rq3/metrics_ddh.csv'
file_lsb = '../results/rq3/metrics_lsb.csv'
file_udh = '../results/rq3/metrics_udh.csv'
#
# Reading the files
#
...
#
plt.grid(True)
plt.savefig("../results/rq3_plot_ncc.pdf", bbox_inches='tight', dpi=500)